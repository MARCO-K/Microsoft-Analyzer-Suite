...
Remove-Module Microsoft-Analyzer-Suite -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\Microsoft-Analyzer-Suite.psd1"
Import-Module "$PSScriptRoot\..\Microsoft-Analyzer-Suite.psm1" -Force
