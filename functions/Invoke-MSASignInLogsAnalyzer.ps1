...
#>
    ...
    begin {
        ...
        if ($request.StatusCode -eq 200) {
            Write-PSFMessage -Level 'Verbose' -Message "IPinfo CLI Access Token is valied" -FunctionName $MyInvocation.MyCommand.Name
        } else {
    ...
    process {
        ...
        #region import Blacklist and Whitelist
        # import Blacklists
        if ($Blacklist) {
        ...
        Function Start-Processing {
            ...
            # Import JSON
            $Data = $logfile | ConvertFrom-Json | Sort-Object { $_.CreatedDateTime -as [datetime] } -Descending
